...
import cn.com.myframe.universalimageloader.core.assist.LoadedFrom;
import cn.com.myframe.universalimageloader.core.assist.ViewScaleType;
import cn.com.myframe.universalimageloader.core.download.ImageDownloader;
import cn.com.myframe.universalimageloader.core.imageaware.ImageAware;
import cn.com.myframe.universalimageloader.core.imageaware.ImageViewAware;
import cn.com.myframe.universalimageloader.core.imageaware.NonViewAware;
import cn.com.myframe.universalimageloader.core.listener.ImageLoadingListener;
import cn.com.myframe.universalimageloader.core.listener.ImageLoadingProgressListener;
import cn.com.myframe.universalimageloader.core.listener.SimpleImageLoadingListener;
import cn.com.myframe.universalimageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain cn.com.myframe.universalimageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain cn.com.myframe.universalimageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain cn.com.myframe.universalimageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain cn.com.myframe.universalimageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain cn.com.myframe.universalimageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
...
//		String memoryCacheKey = MemoryCacheUtils.generateKey(uri, targetSize);
		...
		if (options.isGetImageFromeNet()) {
			removeCache(uri,memoryCacheKey);
		}
	 ...
	 * @param uri
	 */
	private void  removeCache(String memoryCacheKey,String uri) {
		MyUtils.log(LruMemoryCache.class,"memoryCacheKey="+memoryCacheKey);
		MyUtils.log(LruMemoryCache.class,"uri="+uri);
		configuration.memoryCache.remove(memoryCacheKey);
		File imageFile = engine.configuration.diskCache.get(uri);
	 ...
	 * {@link cn.com.myframe.universalimageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link cn.com.myframe.universalimageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link cn.com.myframe.universalimageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain cn.com.myframe.universalimageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
