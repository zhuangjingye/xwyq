 ...
 *******************************************************************************/
package cn.com.myframe.universalimageloader.core.imageaware;
 ...
 * through {@link cn.com.myframe.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link cn.com.myframe.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain cn.com.myframe.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link cn.com.myframe.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain cn.com.myframe.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *Drawable) for empty Uri},
	 * {@linkplain cn.com.myframe.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *Drawable) on loading} or
	 * {@linkplain cn.com.myframe.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain cn.com.myframe.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link cn.com.myframe.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link cn.com.myframe.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
